...
<html>
    ...
    label
    {
      ...
      div.error{
        ...
        <% 
            ...
            UserProfiles up= updao.getProfiles(Integer.parseInt(updateID));
        %>
    ...
    <body id="myPage">
        ...
        <h3 style="margin: auto; text-align: center;">User Profile Update</h3>
        <br>
        
        <form id="userFormUp" action="UserProUpdate?id=<%=updateID %>" method="post" style="margin: auto; text-align: center; width: 60%" >
        <div class="row">
                        <div  class="col-md-6 form-group" >
                            <label for="username">Name </label>
                            <input type="text" class="form-control" id="username" placeholder="UserName" name="UserName" value="<%=up.getName()%>"/>
                        </div>
                    
                        <div class="col-md-6 form-group">
                            <label for="email">Email </label>
                            <input type="email"  class="form-control" id="email" placeholder="Email" name="UserEmail" value="<%=up.getEmail()%>"/>
                        </div>
            <br>
                        <div class="col-md-6 form-group">
